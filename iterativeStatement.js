...
// 6) Write a JavaScript program that iterates integers from 1 to 100. But for multiples of three print "coders" instead of the number and for multiples of five print "coding". For numbers multiples of both three and five print "coders coding school".
{
    for(let a=1; a<=100;a++){
        if(a%3==0){
            console.log('coders');
